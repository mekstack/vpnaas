...
goog.exportSymbol('proto.vpnaas.UserConfig.ServerPeer', null, global);
 ...
 * @constructor
 */
proto.vpnaas.UserConfig.ServerPeer = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.vpnaas.UserConfig.ServerPeer.repeatedFields_, null);
};
goog.inherits(proto.vpnaas.UserConfig.ServerPeer, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.vpnaas.UserConfig.ServerPeer.displayName = 'proto.vpnaas.UserConfig.ServerPeer';
}
...
proto.vpnaas.UserConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    userPeer: (f = msg.getUserPeer()) && proto.vpnaas.Peer.toObject(includeInstance, f),
    serverPeer: (f = msg.getServerPeer()) && proto.vpnaas.UserConfig.ServerPeer.toObject(includeInstance, f),
...
proto.vpnaas.UserConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = new proto.vpnaas.Peer;
      reader.readMessage(value,proto.vpnaas.Peer.deserializeBinaryFromReader);
      msg.setUserPeer(value);
      break;
    case 2:
      var value = new proto.vpnaas.UserConfig.ServerPeer;
      reader.readMessage(value,proto.vpnaas.UserConfig.ServerPeer.deserializeBinaryFromReader);
      msg.setServerPeer(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setDns(value);
...
proto.vpnaas.UserConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getServerPeer();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.vpnaas.UserConfig.ServerPeer.serializeBinaryToWriter
    );
  }
  f = message.getDns();
  if (f.length > 0) {
 ...
 * @const
 */
proto.vpnaas.UserConfig.ServerPeer.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.toObject = function(opt_includeInstance) {
  return proto.vpnaas.UserConfig.ServerPeer.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.vpnaas.UserConfig.ServerPeer} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.vpnaas.UserConfig.ServerPeer.toObject = function(includeInstance, msg) {
  var f, obj = {
    pubkey: (f = msg.getPubkey()) && proto.vpnaas.Pubkey.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.vpnaas.UserConfig.ServerPeer}
 */
proto.vpnaas.UserConfig.ServerPeer.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.vpnaas.UserConfig.ServerPeer;
  return proto.vpnaas.UserConfig.ServerPeer.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.vpnaas.UserConfig.ServerPeer} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.vpnaas.UserConfig.ServerPeer}
 */
proto.vpnaas.UserConfig.ServerPeer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.vpnaas.UserConfig.ServerPeer.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.vpnaas.UserConfig.ServerPeer} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.vpnaas.UserConfig.ServerPeer.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPubkey();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.vpnaas.Pubkey}
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.getPubkey = function() {
  return /** @type{?proto.vpnaas.Pubkey} */ (
    jspb.Message.getWrapperField(this, proto.vpnaas.Pubkey, 1));
};
...
/**
 * @param {?proto.vpnaas.Pubkey|undefined} value
 * @return {!proto.vpnaas.UserConfig.ServerPeer} returns this
*/
proto.vpnaas.UserConfig.ServerPeer.prototype.setPubkey = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.vpnaas.UserConfig.ServerPeer} returns this
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.clearPubkey = function() {
  return this.setPubkey(undefined);
};
 ...
 * @return {boolean}
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.hasPubkey = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.getEndpoint = function() {
 ...
 * @return {!proto.vpnaas.UserConfig.ServerPeer} returns this
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.setEndpoint = function(value) {
 ...
 * @return {!Array<string>}
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.getAllowedIpsList = function() {
 ...
 * @return {!proto.vpnaas.UserConfig.ServerPeer} returns this
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.setAllowedIpsList = function(value) {
 ...
 * @return {!proto.vpnaas.UserConfig.ServerPeer} returns this
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.addAllowedIps = function(value, opt_index) {
 ...
 * @return {!proto.vpnaas.UserConfig.ServerPeer} returns this
 */
proto.vpnaas.UserConfig.ServerPeer.prototype.clearAllowedIpsList = function() {
  return this.setAllowedIpsList([]);
};


/**
 * optional Peer user_peer = 1;
 * @return {?proto.vpnaas.Peer}
 */
proto.vpnaas.UserConfig.prototype.getUserPeer = function() {
...
*/
proto.vpnaas.UserConfig.prototype.setUserPeer = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.vpnaas.UserConfig} returns this
 */
proto.vpnaas.UserConfig.prototype.clearUserPeer = function() {
  return this.setUserPeer(undefined);
};
 ...
 * @return {boolean}
 */
proto.vpnaas.UserConfig.prototype.hasUserPeer = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional ServerPeer server_peer = 2;
 * @return {?proto.vpnaas.UserConfig.ServerPeer}
 */
proto.vpnaas.UserConfig.prototype.getServerPeer = function() {
  return /** @type{?proto.vpnaas.UserConfig.ServerPeer} */ (
    jspb.Message.getWrapperField(this, proto.vpnaas.UserConfig.ServerPeer, 2));
};


/**
 * @param {?proto.vpnaas.UserConfig.ServerPeer|undefined} value
 * @return {!proto.vpnaas.UserConfig} returns this
*/
proto.vpnaas.UserConfig.prototype.setServerPeer = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.vpnaas.UserConfig} returns this
 */
proto.vpnaas.UserConfig.prototype.clearServerPeer = function() {
  return this.setServerPeer(undefined);
};
 ...
 * @return {boolean}
 */
proto.vpnaas.UserConfig.prototype.hasServerPeer = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {string}
 */
proto.vpnaas.UserConfig.prototype.getDns = function() {
 ...
 * @return {!proto.vpnaas.UserConfig} returns this
 */
proto.vpnaas.UserConfig.prototype.setDns = function(value) {
